        ...
        try:
            ...
            if choice == 1:
                ...
                if choice2 == 1:
                    ...
                    gender = input()
                    lore_text('Enter the player\'s health: ')
                    health = int(input())
                    return createEntity('character', category='player', name=name, gender=gender, inventory=[], health=health)
                elif choice2 == 2:
                    lore_text('Enter the zombie\'s health: ')
                    health = int(input())
                    lore_text('Enter the zombie\'s damage: ')
                    damage = int(input())
                    return createEntity('character', category='zombie', health=health, damage=damage)
            elif choice == 2:
